...
public class DocumentoFiscal {
    ...
    public DocumentoFiscal(Empresa empresa, Vendedor vendedor, String nota, LocalDate emissao, double valorNota, double valorCredito) {
        setEmpresa(empresa);
    ...
    public DocumentoFiscal(String linha, Vendedor vendedor) throws ParseException {
        ...
        DocumentoFiscal docGravacao = new DocumentoFiscal(empresa, vendedor, nota, emissao, valorNota, valorCredito);
    ...
    public String toString() {
        return "DocumentoFiscal{" + "Vendedor=" + vendedor + ", Empresa=" + empresa + ", Nota=" + nota + ", Valor Nota=" + valorNota + ", Valor Credito=" + valorCredito + '}';
    }
